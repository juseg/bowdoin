...
\begin{abstract}
    ...
    2.07\,$^\circ$C on their entire depth. Englacial warming up to
...
% ----------------------------------------------------------------------
    ...
    that, as the glaciers thin due to enhanced surface melt, the gravitational
    force acting on the ice is increasingly counterbalanced by buoyancy forces
    from the ocean. Basal friction is
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    higher than the mean annual air temperature \citep{Jania.etal.1996} have
    been explained by latent meltwater refreezing.
