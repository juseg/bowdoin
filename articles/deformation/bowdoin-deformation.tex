...
%\end{abstract}
    ...
    Data flow: readings -> tilt -> strain rate -> shear (+GNSS) -> sliding.

    Discussed with Harry Mon 21 Sep

    Fig.~1 Bowdoin map and borehole setup

    Fig.~2 Tilt rates with zoom for daily

    Fig.~3 All time series (surfave, shear, slip ratio)

    Fig.~4 Creep diagram in small format

    Fig.~5 Cross-correlation between tilts and speed

    The shear profiles would be include as inset somewhere.

    Absolute tilt time series and anything two-dimensional is not included.
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
% \subsection{Discarded discussion of strain heating temporal variations}
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
